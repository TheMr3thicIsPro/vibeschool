-- Simple RLS Policies for Vibe School
...
-- Simplified Conversations policies (to avoid recursion)
...
-- Simplified Conversation participants policies
...
-- Simplified Message reactions policies
