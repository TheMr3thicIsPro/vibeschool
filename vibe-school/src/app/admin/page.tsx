    ...
    <AppShell>
      {showPasswordInput ? (
        ...
        <div className="container mx-auto px-4 py-8 h-screen flex flex-col">
          ...
          <div className="flex space-x-1 mb-6 bg-gray-800 p-1 rounded-lg w-fit">
            ...
            {profile?.role === 'admin' && (
              <button 
                ...
                className={`px-4 py-2 rounded-md transition-colors hover-lift ${activeTab === 'assignments' ? 'bg-accent-primary text-white border border-accent-primary' : 'text-gray-300 hover:text-white'}`}
              >
                Assignments
              </button>
            )}
          ...
          {activeTab === 'assignments' && profile?.role === 'admin' && (
            <div className="flex-1 flex flex-col min-h-0">
