    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            if (error) {
                ...
                setErrorMessage(`Signup failed: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$authErrors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mapSupabaseAuthError"])(error)} (Code: ${error.code})`);
                return;
            }
            ...
            setErrorMessage((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$authErrors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mapSupabaseAuthError"])(err));
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__830ad8dc._.js.map