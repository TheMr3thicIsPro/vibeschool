...
"[project]/src/context/AuthContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/services/challengeService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function computeStatus(challenge) {
    ...
    if (now < start) return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$challenges$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChallengeStatus"].UPCOMING;
    if (now > end) return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$challenges$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChallengeStatus"].ENDED;
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$challenges$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChallengeStatus"].ACTIVE;
}
...
const getChallenges = async (filters = {})=>{
    try {
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('challenges').select(`
        *,
...
const joinChallenge = async (input, userId)=>{
    try {
        ...
        const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, basics_completed').eq('id', userId).single();
        if (!profile?.basics_completed) {
            throw new Error('You must complete the Basics Module before joining challenges');
        }
        // Fetch challenge
        const { data: challenge, error: chErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('challenges').select('*').eq('id', input.challenge_id).single();
        if (chErr || !challenge) {
        ...
        if (status === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$challenges$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChallengeStatus"].ENDED) {
        ...
        const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('challenge_participants').select('id').eq('challenge_id', input.challenge_id).eq('user_id', userId).maybeSingle();
        if (existing?.id) {
            throw new Error('You have already joined this challenge');
        }
        const paymentStatus = challenge.type === 'paid' ? 'pending' : 'paid';
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('challenge_participants').insert([
            {
...
const submitToChallenge = async (input, userId)=>{
    try {
        ...
        const { data: participant } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('challenge_participants').select('id').eq('challenge_id', input.challenge_id).eq('user_id', userId).maybeSingle();
        if (!participant?.id) {
            throw new Error('You must join the challenge before submitting');
        }
        // Fetch challenge to validate deadline
        const { data: challenge } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('challenges').select('submission_deadline').eq('id', input.challenge_id).single();
        const deadline = new Date(challenge.submission_deadline);
        if (new Date() > deadline) {
            throw new Error('Submission deadline has passed');
        }
        // Check existing submission
        const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('submissions').select('*').eq('challenge_id', input.challenge_id).eq('user_id', userId).maybeSingle();
        ...
        if (input.file) {
            ...
            const upload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadFile"])('challenge-submissions', path, input.file);
            fileUrl = upload.url;
            ...
            if (existing?.file_url) {
                try {
                    ...
                    if (oldName) {
                        ...
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteFile"])('challenge-submissions', oldPath);
                    }
                } catch (delErr) {
        ...
        `).single();
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('submissions').insert([
                {
                    challenge_id: input.challenge_id,
                    user_id: userId,
                    file_url: fileUrl,
...
const ProtectedRoute = ({ children })=>{
    ...
    const hydrated = undefined, setHydrated = undefined;
    const state = undefined;
    const user = undefined, authLoading = undefined;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/AuthContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$challengeService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/challengeService.ts [app-ssr] (ecmascript)");
...
const ChallengesPage = ()=>{
    ...
    const [myChallenges, setMyChallenges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchChallenges = async ()=>{
            try {
                ...
                const allChallenges = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$challengeService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getChallenges"])({
                    ...filters,
                ...
                if (user?.id) {
                    const userChallenges = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$challengeService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserChallenges"])(user.id);
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        displayedChallenges.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                            children: displayedChallenges.map((challenge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    challenge.user_participation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            !profile?.basics_completed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2540baca._.js.map