...
"[project]/src/services/profileService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getUserProfile = async (userId)=>{
    ...
    let { data, error, status } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', userId).maybeSingle();
    ...
    if (error) {
        ...
        if (!authError && user && user.email) {
            ...
            const { data: newProfile, error: insertError, status: insertStatus } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').upsert([
                {
                    id: userId,
                    email: user.email,
...
const updateUserProfile = async (userId, profileData)=>{
    ...
    if (profileData.username) {
        ...
        const { data: existingUser, error: checkError, status: checkStatus } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('username').eq('username', profileData.username).neq('id', userId).maybeSingle();
    ...
    const { data, error, status } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update(profileData).eq('id', userId).select().maybeSingle();
...
const uploadProfilePicture = async (userId, file)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('avatars').upload(fileName, file, {
        cacheControl: '3600',
        upsert: false
    });
    ...
    // Get public URL
    const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('avatars').getPublicUrl(fileName);
...
const createProfile = async (userId, email, username)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').upsert([
        {
            id: userId,
            email: email,
            username: username
...
const getAllProfiles = async (limit = 20, offset = 0)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, username, email, avatar_url, bio, created_at').range(offset, offset + limit - 1);
...
const searchProfiles = async (searchTerm)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, username, email, avatar_url, bio, created_at').ilike('username', `%${searchTerm}%`).limit(20);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/AuthContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$profileService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/profileService.ts [app-ssr] (ecmascript)");
...
const ProfilePage = ()=>{
    ...
    const handleSave = async ()=>{
        ...
        try {
            const updatedProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$profileService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateUserProfile"])(user?.id, editData);
    ...
    const handleAvatarUpload = async (e)=>{
        ...
        try {
            setUploading(true);
            const avatarUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$profileService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadProfilePicture"])(user.id, file);
            // Update profile with new avatar URL
            const updatedProfile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$profileService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateUserProfile"])(user.id, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__032c26a3._.js.map