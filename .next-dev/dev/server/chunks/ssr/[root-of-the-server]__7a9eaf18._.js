...
"[project]/src/lib/authErrors.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$authErrors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/authErrors.ts [app-ssr] (ecmascript)");
...
const LoginPage = ()=>{
    ...
    const [showFallbackForm, setShowFallbackForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (error) {
                setErrorMessage((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$authErrors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mapSupabaseAuthError"])(error));
                return;
            }
            router.push('/dashboard');
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a9eaf18._.js.map