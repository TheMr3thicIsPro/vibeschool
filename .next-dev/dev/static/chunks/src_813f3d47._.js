...
"[project]/src/services/courseService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getPublishedCourses = async (userId)=>{
    ...
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('courses').select(`
      id,
      title,
      description,
      thumbnail_url,
    ...
    if (userId) {
        ...
        query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('get_courses_with_progress', {
            user_id: userId
        });
    } else {
        // For non-logged in users, just get courses without progress
        query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('courses').select(`
        id,
        title,
        description,
        thumbnail_url,
...
const getCourseById = async (courseId, userId)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('courses').select(`
      id,
      title,
      description,
      thumbnail_url,
...
const getUserCourseProgress = async (userId, courseId)=>{
    ...
    const { data: modulesData, error: modulesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('modules').select('id').eq('course_id', courseId);
    if (modulesError) {
    ...
    const { data: lessonsData, error: lessonsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('lessons').select('id').in('module_id', moduleIds);
    if (lessonsError) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').select(`
      lesson_id,
      completed,
      completed_at,
...
const getLessonById = async (lessonId)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('lessons').select(`
      id,
      title,
      description,
      video_provider,
...
const getUserLessonProgress = async (userId, lessonId)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').select('completed, completed_at, last_position_seconds').eq('user_id', userId).eq('lesson_id', lessonId).single();
...
const updateUserLessonProgress = async (userId, lessonId, progressData)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').upsert({
        user_id: userId,
        lesson_id: lessonId,
        ...progressData,
...
const getLatestAnnouncements = async (limit = 10)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('announcements').select('id, title, body, created_at').order('created_at', {
        ascending: false
    }).limit(limit);
...
const getModulesByCourse = async (courseId)=>{
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('modules').select(`
      id,
      title,
      description,
      order_index,
...
"[project]/src/services/courseNavigationService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const listCourses = async ()=>{
    ...
    // First, get courses
    const { data: coursesData, error: coursesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('courses').select('id, title, description, thumbnail_url, is_published, created_at').eq('is_published', true).order('created_at', {
        ascending: false
    });
    if (coursesError) {
    ...
    const { data: modulesData, error: modulesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('modules').select('id, course_id, title, order_index').in('course_id', courseIds).order('order_index', {
        ascending: true
    });
    if (modulesError) {
    ...
    if (moduleIds.length > 0) {
        const { data: lessonsRes, error: lessonsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('lessons').select('id, module_id, title, description, order_index, video_provider, video_url, youtube_video_id, is_preview, is_published, created_at').in('module_id', moduleIds).order('order_index', {
            ascending: true
        });
        if (lessonsError) {
...
const getCourse = async (courseId, userId)=>{
    ...
    // Get the course
    const { data: courseData, error: courseError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('courses').select('id, title, description, thumbnail_url, is_published, created_at').eq('id', courseId).eq('is_published', true).single();
    if (courseError) {
    ...
    const { data: modulesData, error: modulesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('modules').select('id, course_id, title, order_index').eq('course_id', courseId).order('order_index', {
        ascending: true
    });
    if (modulesError) {
...
const getCourseProgress = async (userId, courseId)=>{
    ...
    const { data: progressData, error: progressError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').select('lesson_id, completed, updated_at').eq('user_id', userId).in('lesson_id', lessonIds);
    if (progressError) {
...
const getNextLesson = async (userId, courseId)=>{
    ...
    const { data: progressData, error: progressError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').select('lesson_id, completed').eq('user_id', userId).eq('completed', true);
    if (progressError) {
...
const getResumeLesson = async (userId, courseId)=>{
    ...
    const { data: recentProgress, error: recentError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').select(`
      lesson_id,
      completed,
      last_position_seconds
    ...
    if (recentProgress) {
        for (const progress of recentProgress){
            if (!progress.completed && progress.last_position_seconds > 0) {
                ...
                const { data: lessonData, error: lessonError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('lessons').select('*').eq('id', progress.lesson_id).single();
...
const getUserLessonProgress = async (userId, lessonId)=>{
    console.log('getUserLessonProgress: Fetching progress for user:', userId, 'lesson:', lessonId);
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_lesson_progress').select('*').eq('user_id', userId).eq('lesson_id', lessonId).maybeSingle();
    console.log('getUserLessonProgress: Result', {
        data,
        error
    });
...
const checkLessonAccess = async (userId, lessonId)=>{
    console.log('checkLessonAccess: Checking access for user:', userId, 'lesson:', lessonId);
    // First, get the lesson to check if it's a preview
    const { data: lesson, error: lessonError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('lessons').select('is_preview').eq('id', lessonId).single();
    if (lessonError) {
    ...
    const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('plan').eq('id', userId).maybeSingle(); // Use maybeSingle to handle cases where profile doesn't exist yet
    if (profileError) {
...
"[project]/src/components/quiz/QuizQuestion.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const QuizQuestion = ({ question, onAnswer, selectedAnswer, isSubmitted })=>{
    _s();
    const [shortAnswer, setShortAnswer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(typeof selectedAnswer === 'string' ? selectedAnswer : '');
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            question.question_type === 'multiple_choice' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-3",
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        isSubmitted && option.is_correct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                        ...
                                                        isSubmitted && selectedAnswer === option.id && !option.is_correct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                            className: "w-2 h-2 text-white",
                                                            fill: "currentColor",
                                                            viewBox: "0 0 20 20",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                ...
                                children: [
                                    ...
                                    isSubmitted && selectedAnswer && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            isSubmitted && question.question_type === 'multiple_choice' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-3 text-sm",
                children: selectedAnswer && typeof selectedAnswer === 'string' && !question.options?.some((o)=>o.id === selectedAnswer) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(QuizQuestion, "jXiVW1gKcOx2Aamu5aSR1z6T5eo=");
_c = QuizQuestion;
var _c;
__turbopack_context__.k.register(_c, "QuizQuestion");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$quiz$2f$QuizQuestion$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/quiz/QuizQuestion.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const QuizComponent = ({ lessonId, quiz, onComplete })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuizComponent.useEffect": ()=>{
            const checkExistingSubmission = {
                "QuizComponent.useEffect.checkExistingSubmission": async ()=>{
                    if (!user) return;
                    try {
                        const existingSubmission = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserQuizSubmission"])(user.id, lessonId);
            ...
            }["QuizComponent.useEffect.checkExistingSubmission"];
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["submitQuizAnswers"])(user.id, lessonId, answerArray);
    ...
    if (isSubmitted) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-6",
                    children: quiz.questions.map((question)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$quiz$2f$QuizQuestion$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QuizQuestion"], {
                            question: question,
...
_s(QuizComponent, "GK8/fGNTVTjRX7A7FdzhUFwUJIQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"]
    ];
});
...
"[project]/src/lib/youtube.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/reviews/LessonReviewForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LessonReviewForm = ({ lessonId })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LessonReviewForm.useEffect": ()=>{
            const init = {
                "LessonReviewForm.useEffect.init": async ()=>{
                    if (!user) return;
                    try {
                        setLoading(true);
                        const myReview = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$lessonReviewService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMyLessonReview"])(user.id, lessonId);
                        if (myReview) {
            ...
            }["LessonReviewForm.useEffect.init"];
            init();
        }
    }["LessonReviewForm.useEffect"], [
        user,
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$lessonReviewService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["upsertLessonReview"])(user.id, lessonId, {
                rating,
                comment,
...
_s(LessonReviewForm, "x2TuL20T1jsTGO3Jhulw7WVaAfE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"]
    ];
});
...
var _c;
__turbopack_context__.k.register(_c, "LessonReviewForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/learn/[lessonId]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/courseService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseNavigationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/courseNavigationService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/quizService.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$youtube$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/youtube.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$reviews$2f$LessonReviewForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/reviews/LessonReviewForm.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const LessonPlayer = ()=>{
    _s();
    const { lessonId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    const { state } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const user = state.user;
    ...
    const [devLogsShown, setDevLogsShown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // For dev diagnostics
    ...
    const [quizLoading, setQuizLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [quizSubmission, setQuizSubmission] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [playerEl, setPlayerEl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const playerElRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LessonPlayer.useCallback[playerElRef]": (node)=>{
            console.log('YT DEBUG: playerElRef called with node:', !!node);
            setPlayerEl(node);
        }
    }["LessonPlayer.useCallback[playerElRef]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LessonPlayer.useEffect": ()=>{
            if (user && lessonId) {
                loadLessonData();
            }
        }
    ...
    const loadLessonData = async ()=>{
        try {
            setLoading(true);
            // Check access first
            const accessResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkLessonAccess"])(user.id, lessonId);
            ...
            // Get lesson details
            const lessonData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLessonById"])(lessonId);
            setLesson(lessonData);
            // Get user progress
            const progressData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseNavigationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserLessonProgress"])(user.id, lessonId);
            ...
            try {
                ...
                if (lessonQuiz) {
                    const submission = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$quizService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQuizSubmissionByLessonId"])(user.id, lessonId);
                    if (submission) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LessonPlayer.useEffect": ()=>{
            ...
            const initializePlayer = {
                "LessonPlayer.useEffect.initializePlayer": async ()=>{
                    if (cancelled) return;
                    try {
                        console.log('YT: loading API for video:', videoId);
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$youtube$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadYouTubeIFrameAPI"])();
                        if (cancelled || !playerEl) return;
                        console.log('YT: creating player for video:', videoId);
                        // Clean up existing player if any
                        if (playerRef.current) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$youtube$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["destroyPlayer"])(playerRef.current);
                        }
                        // Create new player
                        playerRef.current = new window.YT.Player(playerEl, {
                            ...
                            events: {
                                onReady: {
                                    "LessonPlayer.useEffect.initializePlayer": (event)=>{
                                ...
                                onError: {
                                    "LessonPlayer.useEffect.initializePlayer": (error)=>{
        ...
        "LessonPlayer.useEffect": ()=>{
            ...
            if (isPlaying && playerRef.current) {
                ...
                timerRef.current = setInterval({
                    "LessonPlayer.useEffect": async ()=>{
                        try {
                            const currentTime = playerRef.current?.getCurrentTime();
                            if (currentTime !== undefined) {
                                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseNavigationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserLessonProgress"])(user.id, lessonId, {
                ...
                }["LessonPlayer.useEffect"], 5000); // Update every 5 seconds
            }
            return ({
                "LessonPlayer.useEffect": ()=>{
                    if (timerRef.current) {
    ...
    const handleNextLesson = async ()=>{
        ...
        try {
            ...
            const nextLesson = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$courseNavigationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNextLesson"])(user.id, courseId);
            if (nextLesson) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            !playerReady && hasVideo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            ("TURBOPACK compile-time value", "development") === 'development' && !playerEl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: progress.completed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            quiz && !quizPassed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$reviews$2f$LessonReviewForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        lessonId: lessonId
                    }, void 0, false, {
                        fileName: "[project]/src/app/learn/[lessonId]/page.tsx",
                        lineNumber: 528,
                    ...
                    !quizLoading && quiz && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        id: "quiz-section",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$quiz$2f$QuizComponent$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QuizComponent"], {
                                lessonId: lessonId,
                                quiz: quiz,
                                onComplete: (passed)=>{
                            ...
                            !quizPassed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(LessonPlayer, "qEnkeHX0ygt5TRUvPRKtfKCjA0c=", false, function() {
    return [
...
//# sourceMappingURL=src_813f3d47._.js.map